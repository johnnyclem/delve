 ...
 */
router.post("/storage/uploads/request-url", requireAuth, requireCampaignMember, async (req: Request, res: Response) => {
 ...
 */
router.get("/storage/objects/*path", requireAuth, requireCampaignMember, async (req: Request, res: Response) => {
  try {
